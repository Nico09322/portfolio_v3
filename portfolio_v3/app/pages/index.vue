...
onMounted(() => {
    ...
    gsap.from(splitHeadline.value.chars, {
        duration: 0.5, y: 250, stagger: 0.03, delay: 0.5, ease: "power2.out"
    });

    gsap.from(splitName.value.words, {
        duration: 0.5, y: 100, stagger: 0.075, delay: 1, ease: "power2.out"
    })

    gsap.from(navDivider.value, {
        y: -200, duration: 0.75, delay: 0.75, ease: "power2.inOut"
    })

    gsap.from(profilePic.value, {
        y: -200, duration: 0.75, delay: 1, ease: "power2.inOut"
    })

    gsap.from(nav.value, {
        y: -200, duration: 0.5, delay: 1.25, ease: "power2.inOut", stagger: 0.05
    })

    gsap.from(unterstrichRef.value.querySelectorAll("path"), {
        duration: 0.2, drawSVG: 0, ease: "power2.inOut", stagger: 0.2, delay: 1.5
    })

    gsap.from(scrollRef.value.querySelectorAll("path"), {
        duration: 0.15, drawSVG: 0, ease: "power2.inOut", stagger: 0.15, delay: 2
    })

    gsap.from(picScribble.value.querySelectorAll("path"), {
        duration: 0.75, drawSVG: 0, ease: "power2.inOut", stagger: 0.3, delay: 0.5,
    ...
    mm.add({
        ...
        if (isDesktop) {
            gsap.to(picWrapper.value, {
                x: 350, rotate: 10, duration: 0.75, ease: "power2.inOut",
                scrollTrigger: picWrapper.value,
            })

            gsap.to(profileInfo.value, {
                x: -250, y: -100, rotate: -10, duration: 0.75, delay: 0.25,
                ease: "power2.inOut", scrollTrigger: picWrapper.value,
            })

            gsap.to(JS.value, {
                x: 30, y: -70, duration: 0.75, ease: "power2.inOut", delay: 0.25,
                scrollTrigger: picWrapper.value,
            })

            gsap.to(nuxt.value, {
                x: 100, y: -40, rotate: 5, duration: 0.75, ease: "power2.inOut",
                delay: 0.25, scrollTrigger: picWrapper.value,
            })

            gsap.to(vue.value, {
                x: 110, y: -10, rotate: 7, duration: 0.75, ease: "power2.inOut",
                delay: 0.25, scrollTrigger: picWrapper.value,
            })

            gsap.to(tailwind.value, {
                x: -100, y: -75, rotate: -7, duration: 0.75, ease: "power2.inOut",
                delay: 0.25, scrollTrigger: picWrapper.value,
            })

            gsap.to(strapi.value, {
                x: 20, y: -40, rotate: 2, duration: 0.75, ease: "power2.inOut",
                delay: 0.25, scrollTrigger: picWrapper.value,
            })

            gsap.to(supabase.value, {
                x: -280, y: -150, rotate: -15, duration: 0.75, ease: "power2.inOut",
                delay: 0.25, scrollTrigger: picWrapper.value,
            })

            gsap.to(figma.value, {
                x: -170, y: -130, rotate: -10, duration: 0.75, ease: "power2.inOut",
                delay: 0.25, scrollTrigger: picWrapper.value,
            })

            gsap.to(email.value, {
                x: -430, y: -100, rotate: -5, duration: 0.75, ease: "power2.inOut",
                delay: 0.25, scrollTrigger: picWrapper.value,
            })

            gsap.to(github.value, {
                x: -420, y: -15, rotate: -8, duration: 0.75, ease: "power2.inOut",
                delay: 0.3, scrollTrigger: picWrapper.value,
            })

            gsap.to(linkedin.value, {
                x: -400, y: 70, rotate: -11, duration: 0.75, ease: "power2.inOut",
                delay: 0.35, scrollTrigger: picWrapper.value,
            })

            gsap.to(blender.value, {
                x: -320, y: 190, rotate: 8, duration: 0.75, ease: "power2.inOut",
                delay: 0.2, scrollTrigger: picWrapper.value,
            })

            gsap.to(gsap2.value, {
                x: 100, y: -10, rotate: -3, duration: 0.75, delay: 0.2,
                ease: "power2.inOut", scrollTrigger: picWrapper.value,
            })
        }
        ...
        if (isMobile) {
            ...
            gsap.set(picWrapper.value, { x: 0, rotate: 0 })
            gsap.set(profileInfo.value, { x: 0, y: 0, rotate: 0 })

            gsap.from(
                [JS.value, nuxt.value, vue.value, tailwind.value, strapi.value,
                 supabase.value, figma.value, email.value, github.value,
                 linkedin.value, blender.value, gsap2.value],
                {
                    opacity: 0,
                    y: 20,
                    duration: 0.4,
        ...
        <div class="bg-[#FFFAEF] w-full h-[200vh] " id="smooth-wrapper">
            <div id="smooth-content">
                        <div class="flex flex-col gap-[2rem] justify-center items-center w-full h-[100vh] z-0">
                            ...
                            <div class="absolute sm:right-[10rem] lg:right-[20rem] top-[80vh]">
                ...
                <div class="mt-[10rem] h-auto lg:h-[50rem] flex items-center flex-col relative">
                    <h2 ref="ueberMich" class="font-kavoon text-[3rem]"><span class="text-[#D65108]">ÜBER</span> <span class="text-[#591F0A]">MICH</span></h2>
                    <div ref="picWrapper" class="p-[1rem] bg-[#EFA00B] rounded-lg relative mt-[3rem] lg:mt-[8rem] z-20">
                        <img :src="bildGroß" alt="" class="rounded-lg w-[16rem] lg:w-[20rem]"/>
                            <svg ref="picScribble" class="absolute top-[2.5rem] right-[6rem] lg:top-[3.5rem] lg:right-[7.8rem] z-10 scale-[110%] lg:scale-[145%]" width="71" height="90" viewBox="0 0 71 90" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div ref="profileInfo" class="w-[18rem] h-[13rem] bg-[#D65108] rounded-lg p-[1rem] relative lg:absolute lg:top-60 z-10 mt-[2rem] lg:mt-0">
                    ...
                    <div class="font-taviraj text-[#FFFAEF] flex flex-wrap justify-center gap-3 mt-[2rem] w-full px-[1rem]
                                lg:absolute lg:top-60 lg:flex-col lg:flex-nowrap lg:gap-0 lg:mt-0 lg:w-auto lg:px-0">
                        <div ref="JS" class="bg-[#591F0A] w-[9rem] h-[3.5rem] lg:w-[10rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:-z-10">
                            <Icon name="skill-icons:javascript" class="w-[2rem] h-[2rem]"/>
                            <p>Javascript</p>
                        </div>
                        <div ref="nuxt" class="bg-[#EFA00B] w-[7rem] h-[3.5rem] lg:w-[7rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:-z-10">
                            <Icon name="skill-icons:nuxtjs-dark" class="w-[2rem] h-[2rem]"/>
                            <p>Nuxt</p>
                        </div>
                        <div ref="vue" class="bg-[#D65108] w-[7rem] h-[3.5rem] lg:w-[7rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:-z-10">
                            <Icon name="devicon:vuejs" class="w-[2rem] h-[2rem]"/>
                            <p>Vue</p>
                        </div>
                        <div ref="tailwind" class="bg-[#EFA00B] w-[9rem] h-[3.5rem] lg:w-[9rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:-z-10">
                            <Icon name="vscode-icons:file-type-tailwind" class="w-[2rem] h-[2rem]"/>
                            <p>Tailwind</p>
                        </div>
                        <div ref="strapi" class="bg-[#591F0A] w-[7rem] h-[3.5rem] lg:w-[7rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:-z-10">
                            <Icon name="logos:strapi-icon" class="w-[2rem] h-[2rem]"/>
                            <p>Strapi</p>
                        </div>
                        <div ref="supabase" class="bg-[#D65108] w-[9rem] h-[3.5rem] lg:w-[9rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:-z-10">
                            <Icon name="skill-icons:supabase-dark" class="w-[2rem] h-[2rem]"/>
                            <p>Supabase</p>
                        </div>
                        <div ref="figma" class="bg-[#D65108] w-[8rem] h-[3.5rem] lg:w-[8rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:-z-10">
                            <Icon name="skill-icons:figma-dark" class="w-[2rem] h-[2rem]"/>
                            <p>Figma</p>
                        </div>
                        <div ref="blender" class="bg-[#EFA00B] w-[9rem] h-[3.5rem] lg:w-[9rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:absolute lg:top-[5rem] lg:right-[5rem] lg:z-0">
                            <Icon name="logos:blender" class="w-[2rem] h-[2rem]"/>
                            <p>Blender</p>
                        </div>
                        <div ref="gsap2" class="bg-[#591F0A] w-[7.5rem] h-[3.5rem] lg:w-[7.5rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:absolute lg:top-[20rem] lg:right-[5rem] lg:z-0">
                            <Icon name="simple-icons:gsap" class="w-[2rem] h-[2rem]"/>
                            <p>GSAP</p>
                        </div>
                        <div ref="email" class="bg-[#33ADFF] w-[7.5rem] h-[3.5rem] lg:w-[7.5rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:absolute lg:top-[3rem] lg:right-[5rem] lg:z-0 cursor-[url('/pointer.svg'),_pointer] hover:shadow-[10px_10px_0px_0px_rgba(0,_0,_0,_1)] hover:duration-200" @mouseenter="emailHover" @mouseleave="emailLeave" @click="openMail">
                            <Icon name="dashicons:email" class="w-[2rem] h-[2rem]"/>
                            <p>Email</p>
                        </div>
                        <div ref="github" class="bg-[#0267C1] w-[8rem] h-[3.5rem] lg:w-[8rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:absolute lg:top-[4rem] lg:right-[5rem] lg:z-0 cursor-[url('/pointer.svg'),_pointer] hover:shadow-[10px_10px_0px_0px_rgba(0,_0,_0,_1)] hover:duration-200" @mouseenter="emailHover" @mouseleave="emailLeave" @click="openGit">
                            <Icon name="ri:github-fill" class="w-[2rem] h-[2rem]"/>
                            <p>Github</p>
                        </div>
                        <div ref="linkedin" class="bg-[#33ADFF] w-[9rem] h-[3.5rem] lg:w-[9rem] lg:h-[4rem] rounded-lg flex flex-row items-center p-[1rem] gap-3 relative lg:absolute lg:top-[5rem] lg:right-[5rem] lg:z-0 cursor-[url('/pointer.svg'),_pointer] hover:shadow-[10px_10px_0px_0px_rgba(0,_0,_0,_1)] hover:duration-200" @mouseenter="emailHover" @mouseleave="emailLeave" @click="openLinkedIn">
                ...
                <div class="mt-[10rem]">
                    ...
                    <div class="projekt-wrapper overflow-hidden mb-[5rem]">
                        ...
                        <div class="flex flex-col lg:flex-row justify-center items-center mb-[5rem] lg:mb-0">
                            <TransitionGroup name="stack" tag="div" class="w-[80%] lg:w-[65%] grid projekt-container relative mb-[1rem] lg:mb-[10rem] mt-[5rem] place-items-center">
                            ...
                            <button class="group  cursor-[url('/pointer.svg'),_pointer]" @click="cycleCards">
                                <div class="rounded-full flex justify-center items-center p-[0.5rem] flex-col ">
                                    <img src="../assets/svg/weiter.svg" alt="weiter" class="group-hover:scale-110 transition-all duration-150 lg:w-14 lg:h-14"/>
